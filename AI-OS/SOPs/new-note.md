...
2. **Check it does not already exist.** Search the target folder's README index and the vault for the title and obvious synonyms. If a close match exists, propose updating that note instead.
